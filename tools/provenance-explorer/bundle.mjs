...
const [reportArg,controlArg,outputArg]=process.argv.slice(2);
if(!reportArg||!outputArg||!controlArg){console.error("usage: npm run bundle -- REPORT.json CONTROL_REPORT.json OUTPUT_DIRECTORY");process.exit(2)}
...
const control=path.resolve(controlArg),controlText=await readFile(control,"utf8");
