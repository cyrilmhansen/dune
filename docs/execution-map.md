...
runtime PCs. A zero fetch count means only “not observed as an instruction
byte”; it does **not** establish dead code (the bytes may be data, padding,
unreachable, or simply unexercised).
...
| Image | Bytes known/observed | Bytes fetched as instructions | Unique starts | Executions | First / last step | First runtime PC / file offset |
|---|---:|---:|---:|---:|---:|---|
| `A:0:PLI.COM` | 8,064 | 2,697,677 | 1,894 | 1,347,482 | 0 / 2,535,508 | `0100h` / `0000h` |
| `A:0:PLI0.OVL` | 18,048 (141 records) | 419,943 | 3,675 | 219,649 | 14,310 / 643,847 | `2200h` / `0000h` |
| `A:0:PLI1.OVL` | 34,816 (272 records) | 919,934 | 7,627 | 486,720 | 670,277 / 1,638,028 | `2200h` / `0000h` |
| `A:0:PLI2.OVL` | 33,792 (264 records) | 948,326 | 4,941 | 479,722 | 1,663,710 / 2,505,487 | `2200h` / `0000h` |
